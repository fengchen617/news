package com.bawei6.basemodel.net;

import android.text.TextUtils;

import com.bawei6.basemodel.net.api.TokenApi;
import com.bawei6.basemodel.net.protocol.resp.TokenRespEntity;
import com.bawei6.basemodel.net.retrofit.LiveDataCallAdapterFactory;
import com.bawei6.basemodel.utils.Config;
            ...
            public Response intercept(Chain chain) throws IOException {
                ...
                if (checkHttpCode401(response)){
                    ...
                    if (TextUtils.isEmpty(token)){
                        MsgUtils.log("Error : token is null...");
                    }
